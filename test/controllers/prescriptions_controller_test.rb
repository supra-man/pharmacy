...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference("Prescription.count") do
      post prescriptions_url, params: { prescription: { customer_id: @prescription.customer_id, medicine_name: @prescription.medicine_name, next_delivery_date: @prescription.next_delivery_date, notes: @prescription.notes } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { customer_id: @prescription.customer_id, medicine_name: @prescription.medicine_name, next_delivery_date: @prescription.next_delivery_date, notes: @prescription.notes } }
